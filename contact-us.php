      ...
      <div class="col-md-6">
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Nomer Telepon <span>*</span></label>
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumber" required>
            </div>
            <div class="form-group">
              <label class="control-label">Pesan Anda <span>*</span></label>
              <textarea class="form-control white_bg" name="message" rows="4" required></textarea>
            </div>
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">Kirim Pesan</button>
            </div>
          </form>
        </div>
      </div>
